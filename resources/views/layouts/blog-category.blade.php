                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse" id="gazetteMenu">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    @foreach($allCategories as $categoryPost)
                                        <li class="nav-item">
                                            <a class="nav-link"
                                               href="{{route('category', $categoryPost)}}">{{$categoryPost->name}}</a>
                                        </li>
                                    @endforeach
                                </ul>
                                <!-- Search Form -->
                            ...
                            <div class="row">
                                <div class="col-12 col-md-5">
                                    <div class="editorial-post-thumb">
                                        <img
                                            src="{{$slide->photo ? asset($slide->photo->file) : 'https://via.placeholder.com/800x600'}}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-12 col-md-7">
                                    <div class="editorial-post-content">
                                        ...
                                        <div class="gazette-post-tag">
                                            @foreach($slide->categories as $slideCategories)
                                                <a href="{{route('category', $slideCategories->name)}}">{{$slideCategories->name}}</a>
                                            @endforeach
                                        </div>
                                        <h2><a href="#" class="font-pt mb-15">{{Str::limit($slide->title,50,'...')}}</a>
                                        </h2>
                ...
                <div class="col-12 col-md-4">
                    <div class="gazette-welcome-post">
                        ...
                        <div class="gazette-post-tag">
                            @if($post->categories)
                                @foreach($post->categories as $postcategories)
                                    <a href="{{route('category', $postcategories->name)}}">{{$postcategories->name}}</a>
                                @endforeach
                            @endif
                        </div>
                        ...
                        <div class="single-post-thumb">
                            <img class="img-fluid"
                                 src="{{$post->photo ? asset($post->photo->file) : 'https://via.placeholder.com/800x600'}}"
                                 alt="{{$post->title}}">
                        </div>
                        <!-- Post Excerpt -->
                            <p>{{$post->body}}</p>
                            ...
                            <div class="post-continue-reading-share mt-30">
                                <div class="post-continue-btn">
                                    <a href="{{route('home.post', $post)}}" class="font-pt">Continue Reading <i class="fa fa-chevron-right"
